...
runs = 1:25;
for run in runs
  push!(cases, Dict(:E0 => 1, :K2 => 1, :K1 => 0.0,
                    :kT => 1, :Fz => 0,
                    :Fx => 0, :n => 100, :b => 1, :run => run));
  push!(cases, Dict(:E0 => 5, :K2 => 1, :K1 => 0.0,
                    :kT => 1, :Fz => 0,
                    :Fx => 0, :n => 100, :b => 1, :run => run));
  push!(cases, Dict(:E0 => 5, :K2 => 0.1, :K1 => 0.0,
                    :kT => 1, :Fz => 0,
                    :Fx => 0, :n => 100, :b => 1, :run => run));
  push!(cases, Dict(:E0 => 1, :K2 => 0.1, :K1 => 0.0,
                    :kT => 1, :Fz => 0,
                    :Fx => 0, :n => 100, :b => 1, :run => run));
  push!(cases, Dict(:E0 => 1, :K2 => 1, :K1 => 0.0,
                    :kT => 1, :Fz => 1,
  ...
  push!(cases, Dict(:E0 => 1, :K2 => 1, :K1 => 0.0,
                    :kT => 1, :Fz => 1,
                    :Fx => 1, :n => 100, :b => 1, :run => run));
  push!(cases, Dict(:E0 => 3, :K2 => 1, :K1 => 0.0,
                    :kT => 1, :Fz => 3,
